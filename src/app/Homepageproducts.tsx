  ...
  return (
    <div className="w-full border-b-2 py-16 flex flex-col justify-center bg-[#F4F5F7]">
      <div className="flex flex-col gap-[32px] w-fit mx-auto no-scrollbar">
        ...
        <div className="flex gap-[21px] overflow-x-scroll no-scrollbar flex-wrap justify-center sm:w-full md:w-[1236px] bg-[#F4F5F7]">
          {products.map((product, index) => (
            <div className="bg-white group relative overflow-hidden w-[285px] h-[301px] sm:w-[200px] sm:h-[220px] md:w-[285px] md:h-[301px]">
              <div
